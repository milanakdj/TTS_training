...
# sharing the GPU with the pocket-TTS student distill (~51 GB resident)
...
G=/workspace/milan_nepali_parler_ft/data_gem_a
R=/workspace/milan_nepali_parler_ft/data_replay_a
...
$V -m training.run_parler_tts_training \
  ...
  --output_dir "/workspace/milan_nepali_parler_ft/out_gemra" \
  --temporary_save_to_disk "/workspace/milan_nepali_parler_ft/tmp_codec_gemra" \
  --save_to_disk "/workspace/milan_nepali_parler_ft/prep_gemra" \
  --preprocessing_num_workers 1 --audio_encoder_per_device_batch_size 8 \
  ...
  --do_eval true --evaluation_strategy "steps" --eval_steps 250 --per_device_eval_batch_size 4 \
